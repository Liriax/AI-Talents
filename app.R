...
server <- function(input, output) {
  ...
  #   data <- freq_text[1:n,]
  #   return(data)
  #   # ggplot(data, aes(skills, Freq))+geom_bar(fill="royalblue2", stat = "identity")
  # }
